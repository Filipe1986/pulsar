 ...
 *
 **/
public class InventoryCheckerUS extends AsyncRunner {

    CompletableFuture<Consumer<String>> consumer;
    final String consumerTopicName = Topics.ORDER_BACKLOG_US;
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        InventoryCheckerUS inventoryChecker = new InventoryCheckerUS();
